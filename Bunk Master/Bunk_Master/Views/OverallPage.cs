...
{
    public class OverallPage : ContentPage
    {
        ...
        public OverallPage()
        {
            ...
            var overdata = ViewModel.ClassVMInstance.GetOverdb();
            var repeat_data = overdata.repeat_data.ToString();
            ...
            var sched_grid = new ScheSwitch(true);
            ...
            var DailyGraph = GraphGenInstance.GenerateLineGraph(ViewModel.ClassVMInstance.DatesVMInstance, ViewModel.ClassVMInstance.DatesVMInstance.Opercent, "gpercent", "gdate");
            DailyGraph.StrokeWidth = 1.5;
            DailyGraph.Color = Color.SpringGreen;
            var MinGraph = GraphGenInstance.GenerateFastGraph(ViewModel.ClassVMInstance.DatesVMInstance, ViewModel.ClassVMInstance.DatesVMInstance.OminInstance, "gpercent", "gdate");
            MinGraph.Color = Color.Black;
            MinGraph.StrokeWidth = 1;
            var PredGraph = GraphGenInstance.GenerateFastGraph(ViewModel.ClassVMInstance.DatesVMInstance, ViewModel.ClassVMInstance.DatesVMInstance.Opredict, "gpercent", "gdate");
            ...
            chartZoomPanBehavior.ZoomByRange(secondaryAxis, 40, 60);
            //chartZoomPanBehavior.MaximumZoomLevel = .5f;
            ...
            Label lbl_minper = new Label { Text = "Set Min Percent", TextColor = Color.White, FontSize = 20, HorizontalOptions = LayoutOptions.Center, HorizontalTextAlignment = TextAlignment.Center, VerticalTextAlignment = TextAlignment.Center };
            SfNumericUpDown numericUpDown = new SfNumericUpDown
            {
                Value = 75,
                ParsingMode = ParsingMode.Double,
                AllowNull = false,
                AutoReverse = false,
                StepValue = 5,
                Minimum = 50,
            ...
            Frame frame1 = new Frame { BorderColor = Color.White, CornerRadius = 20, HasShadow = true, IsClippedToBounds = true, Padding = -10, Margin = new Thickness(25, 0), BackgroundColor = Color.Transparent };
            frame1.Content = bt_editdt;
            Frame frame2 = new Frame { BorderColor = Color.White, CornerRadius = 20, HasShadow = true, IsClippedToBounds = true, Padding = -10, Margin = new Thickness(25, 0, 25, 25), BackgroundColor = Color.Transparent };
            ...
            numericUpDown.BindingContext = ViewModel.ClassVMInstance.Overmincut;
            numericUpDown.SetBinding(SfNumericUpDown.ValueProperty, ".");

            #region labels

            //lbl_classinfo.BindingContext = ViewModel.ClassVMInstance.DatesVMInstance.TelemetInstance[0].Daycount;
            //lbl_classinfo.SetBinding(Label.TextProperty, ".", stringFormat: "No of Classes Needed: {0}");
            ...
            dtgrid.ColumnDefinitions.Add(new ColumnDefinition { Width=GridLength.Auto});
            ...
            dtgrid.Children.Add(lbl_minper, 0, 0);
            dtgrid.Children.Add(numericUpDown, 1, 0);
            ...
            {
                if (int.TryParse(e.Value.ToString(), out int min_t))
                {
                    ViewModel.ClassVMInstance.UpdateOverModelMincut(min_t);
                }
            };
        ...
        private void Entry_min_TextChanged(object sender, TextChangedEventArgs e)
        {
